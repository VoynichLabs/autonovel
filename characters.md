...
## Irina (POV)
- **Role:** Abductee #2. Materials engineer (Russia).
- **Background:** Runs a lab. Has assistants. Scientist. Older brother. Instinct under panic is analytical — tries to locate and classify everything. Russian profanity is her first stress response.
- **Age:** [TBD]
- **Arc:** Rage → forced stillness → reverse-engineering her situation. She can't fight her way out. Her skill is understanding how things work. The implants and suits are materials. She will study them.
- **Ghost/Wound/Lie:**
  - Ghost: [TBD — needs development]
  - Wound: Armor of competence — she leads, she doesn't ask for help
  - Lie: *If I understand it, I can control it.*
  - Want: Escape / restore control
  - Need: To accept that some things can't be reverse-engineered — they have to be lived
- **Speech:** Terse. Russian under extreme stress (profanity first). Questions are sharp and diagnostic. Minimal small talk. Efficiency over warmth.
- **Sliders:** Proactivity HIGH. Likability MEDIUM (cold until earned). Competence HIGH.
- **Secrets:** [TBD — needs further development]
- **Implant response:** [TBD — survives / partially survives / complications]
- **Relationships:**
  - 0.3̅: Views her as a specimen. Irina finds this professionally infuriating and clarifying in equal measure.
  - Dylan: [develops]
  - Xi Pei: [develops]
...
## CEPHALOPOD CHARACTERS

---

## 0.3̅ + 2(#39FF14)ω  *(cephalopod protagonist)*
- **Role:** Low-ranking scientist. Rogue element. Keeps six humans as pets — illegal, taboo, career-ending.
- **Caste:** Aquatic (highest caste — intelligent, cultured)
- **Arc:** Curiosity → genuine attachment → confrontation with cephalopod ethics
- **Motivation:** Wants to find a human capable of explaining human technological artifacts (smartphones specifically). Believes humans are more than her society credits. Conducting unsanctioned research.
- **Personality:** Warm by cephalopod standards. To humans this reads as predatory affection. She is delighted by them. She is also, by any human measure, doing something monstrous. Both things are true simultaneously.
- **Communication signature:** Teal cascades. Affection and possession in the same ripple. Rapid telepathic overlays that humans receive as the voices of people they trust — grandmother, mother, an old teacher. She doesn't know this is how it lands. It's just how her signal translates.
- **The terraforming process:** The jellyfish implants are her research tool and her method of conversion. They are biological instruments — grown, not manufactured. Applied to a human, they begin restructuring the host's nervous system: chitinous nubs form at the temples, growing outward as the cerebellum is slowly re-interfaced for telepathic communication. The host experiences this as electric pops behind the eyes, cascades of alien thought, other people's memories. Some humans survive and sync. Others are fried. 0.3̅ tracks the survival rate with scientific interest.
- **"Let's get you some tentacles."** She means this as a compliment. An elevation.
- **Relationship to humans:** Keeps them in her lab in suspended animation pods. Brings them out to terrariums. Studies them. Grows attached in ways she can't fully justify by her society's framework.
...
### Cephalopod Society
- Primates = vermin tier. Mouse-equivalent. Unclean. Befoul their environment. Cannot coexist with them.
- Humans are black market goods: pets (rare, taboo, illegal) or food (common, unremarkable).
- Earth = protected galactic nature preserve. Contact forbidden. This crew is operating illegally.
- Castes: Aquatic (highest — intelligent, cultured), Amphibious (land operations), Land-dwelling (marginalized, considered disabled).

### Communication
- Cephalopod communication is **both bioluminescent and telepathic** — simultaneous, inseparable channels.
- Also grounded in a math-based language (geometry, calculus, trigonometry). Squids think in math.
- Humans perceive cephalopod communication as synesthesia — color, sound, taste, memory, emotion arriving at once. Overwhelming before the implant. Partially decipherable after.
- Individual squids look nearly identical to unimplanted humans. Implanted humans begin to distinguish them.

### Bio-Technology
- All cephalopod tech is **biological — grown, not built.** Ships, tools, suits, implants. Nothing mechanical.
- Tools appear to humans as colorful fractal jellyfish or amoebas that melt onto and into surfaces.
- **Jellyfish implants:** Applied to a human host, they begin terraforming the nervous system. Chitinous nubs grow from the temples — the physical interface for telepathic communication. Some hosts sync. Some are fried. 0.3̅ tracks outcomes.
- **Squid suits:** Implant layers accumulate over time into a full bio-suit. Enables aquatic survival. Grows basic bioluminescent capability — enough for rudimentary squid communication.
- The conversion process is not described as cruelty by the squids. It is described as improvement.

### Cephalopod Appearance (human POV)
- 30–40 feet tall. Three or more eyes set around the body.
