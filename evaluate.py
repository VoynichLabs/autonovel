...
from api_client import call_model as _call_model_raw
...
2. Check for missing NEGATIVE SPACE -- what's absent?
   - Are there gaps in the magic system that would block a specific
     plot scene? (e.g., does the implant create blind spots or failure modes?
...
- character_voice: Remove all dialogue tags mentally. Can you tell who's
  ...
  or as written prose? Does each POV character sound distinct and specific, or
  like a generic protagonist? Does anyone say something surprising -- not
